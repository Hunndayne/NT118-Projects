...
| `/reports/overview` | GET | SUPER_ADMIN, TEACHER | Thống kê dashboard Reports (tổng students/courses/classes/modules + submission stats) | Header `X-Auth-Token` | 200: `{"totalStudents","totalCourses","totalClasses","totalModules","submissionStatistics":{"onTime","late","missing","submissionRate"}}` |
