...
public class NotificationAdminActivity extends BaseAdminActivity {
    ...
    private void setupListeners() {
        ...
        fabSendNotification.setOnClickListener(v -> {
            Intent intent = new Intent(this, SendNotificationAdminActivity.class);
        ...
        apiService.getNotifications(token).enqueue(new Callback<List<Notification>>() {
            ...
            public void onResponse(Call<List<Notification>> call, Response<List<Notification>> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    notificationList.clear();
                    adapter.updateData(notificationList);
                    Toast.makeText(NotificationAdminActivity.this,
